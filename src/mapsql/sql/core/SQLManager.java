...
public class SQLManager {
	 ...
	 * @throws SQLException
	 */
	public String execute(SQLCommand command) throws SQLException, IOException, ParseException {
	 ...
	 * @throws SQLException 
	 */
	public String execute(SQLOperation operation) throws SQLException, IOException, ParseException {
